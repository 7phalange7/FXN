...
class SearchMovieViewModel(private val searchTitle: String) : ViewModel() {
    ...
    private fun getSearchMovie(){
        ...
        coroutineScope.launch {
            var getResultDeferred = SearchApiService.SearchApi.retrofitService.searchForMovies(searchTitle)
